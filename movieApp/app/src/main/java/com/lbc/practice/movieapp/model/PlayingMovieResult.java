...
public class PlayingMovieResult {
    ...
    public static class ResultsBean implements Serializable {
        ...
        public ResultsBean(String poster_path, int vote_count, int id, double vote_average, String title, double popularity, String overview, String release_date, Date storedTime) {
